INSERT INTO series (series_id, title, subgenre_id, author_id) VALUES
(1, "A Song of Ice and Fire", 1, 1),
(2, "Second Series", 2, 2);

INSERT INTO subgenres (subgenre_id, name) VALUES
(1, "medieval"),
(2, "space opera");
...
INSERT INTO books (book_id, title, year, series_id) VALUES
...
INSERT INTO characters (charactor_id, name, motto, species, author_id, series_id) VALUES
...
INSERT INTO character_books (charactor_book_id, book_id, character_id) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 2, 2),
(4, 3, 2),
